...
public final class OpponentFoundOuterClass {
  ...
  public static final class OpponentFound extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.internal_static_com_kerpow_games_freethrow_common_OpponentFound_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.internal_static_com_kerpow_games_freethrow_common_OpponentFound_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.OpponentFound.class, com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.OpponentFound.Builder.class);
    }
    ...
    public static com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.OpponentFound parseFrom(
    ...
    public static com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.OpponentFound parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.OpponentFound parseFrom(
    ...
    public static com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.OpponentFound parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.OpponentFound parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.OpponentFound parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.OpponentFound prototype) {
    ...
    public static final class Builder extends
        ...
        com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.OpponentFoundOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.internal_static_com_kerpow_games_freethrow_common_OpponentFound_descriptor;
      }
      ...
      // Construct using com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.OpponentFound.newBuilder()
      private Builder() {
      ...
      public com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.OpponentFound getDefaultInstanceForType() {
        return com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.OpponentFound.getDefaultInstance();
      }

      public com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.OpponentFound build() {
        com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.OpponentFound result = buildPartial();
      ...
      public com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.OpponentFound buildPartial() {
        com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.OpponentFound result = new com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.OpponentFound(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.OpponentFound) {
          return mergeFrom((com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.OpponentFound)other);
        } else {
      ...
      public Builder mergeFrom(com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.OpponentFound other) {
        if (other == com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.OpponentFound.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.OpponentFound parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (com.kerpow.games.freethrow.common.message.OpponentFoundOuterClass.OpponentFound) e.getUnfinishedMessage();
          throw e;
        } finally {
